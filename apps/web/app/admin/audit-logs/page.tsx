          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-100">
              {filteredLogs.map((l: any) => (
                <tr key={l.id || l._id} className="hover:bg-indigo-50/30 transition-colors">
                  ...
                  <td className="p-4">
                    <span className="px-2.5 py-1 rounded-md font-extrabold text-[10px] uppercase bg-indigo-100 text-indigo-700 border border-indigo-200">
                      {l.action}
                    </span>
                  </td>
                  ...
                  <td className="p-4 text-right">
                    <button
                      ...
                      className="p-2 rounded-xl bg-slate-100 hover:bg-indigo-100 text-slate-700 hover:text-indigo-700 border border-slate-200 hover:border-indigo-300 transition-all text-xs font-bold flex items-center gap-1.5 ml-auto"
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white border border-slate-200 rounded-3xl shadow-2xl w-full max-w-xl overflow-hidden animate-in fade-in zoom-in-95">
            ...
            <div className="p-6 space-y-4 text-xs">
              <div className="grid grid-cols-2 gap-3 p-3.5 rounded-2xl bg-slate-50 border border-slate-200 font-semibold">
                <div>
                  ...
                  <span className="text-indigo-700 font-mono font-bold">{selectedLog.action}</span>
                </div>
                <div>
            ...
            <div className="p-4 border-t border-slate-100 bg-slate-50 text-right">
              <button
                onClick={() => setSelectedLog(null)}
                className="px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs transition-colors shadow-md shadow-indigo-500/20"
              >
                Close Inspector
              </button>
            </div>
