...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-black text-slate-900 dark:text-slate-100 bg-cyber-grid flex items-center justify-center p-4 md:p-12 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-[1360px] rounded-3xl bg-white dark:bg-black border border-slate-200 dark:border-indigo-500/40 shadow-2xl dark:shadow-indigo-950/70 overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[680px] transition-colors duration-300">
        {/* Left Column: Widescreen Persona Hero Graphic (7 Cols) */}
        <div className="lg:col-span-7 relative hidden lg:flex flex-col justify-between p-12 border-r border-slate-200 dark:border-indigo-500/30 overflow-hidden min-h-[650px]">
          ...
          <div className="relative z-20 flex items-center gap-3.5">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-indigo-600 via-blue-600 to-cyan-600 flex items-center justify-center text-white shadow-xl shadow-indigo-500/40">
        ...
        <div className="lg:col-span-5 p-10 md:p-12 flex flex-col justify-center space-y-6 bg-white dark:bg-[#040406] backdrop-blur-2xl border-l border-slate-200 dark:border-indigo-500/20 transition-colors duration-300">
          <div className="text-center space-y-2">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-indigo-600 via-blue-600 to-cyan-600 flex items-center justify-center text-white mx-auto shadow-lg shadow-indigo-500/30 lg:hidden">
